...
const CustomPayFormApp = forwardRef(({
    documentType,
    documentUser,
    setFormResponse,
    showForm,
                ...
                <div className={styles.formSection} ref={modalRef} >
                            ...
                            <div className={styles.formInfoCard}>
                                <div className={styles.formRow}>
                                    <div className={styles.inputContainer}>
                                        ...
                                        <div id="txtNumeroTarjeta" className={`form-control ${styles.formControl} ${errors.cardNumber && touched.cardNumber && styles.formError}`}></div>
                                        {
                                ...
                                <div className={styles.formRow}>
                                    <div className={styles.inputContainer}>
                                        ...
                                        <div id="txtFechaVencimiento" className={`form-control ${styles.formControl} ${errors.cardExpiry && touched.cardExpiry && styles.formError}`}></div>
                                        {
                                    ...
                                    <div className={styles.inputContainer}>
                                        ...
                                        <div id="txtCvv" className={`form-control ${styles.formControl} ${errors.cardCvv && touched.cardCvv && styles.formError}`}></div>
                                        {
                                    ...
                                    <div className={styles.inputContainer}>
                                        <div className={styles.formCheckboxContainer}>
                                            <input
                                                ...
                                                name='tyc'
                                                checked={values.tyc}
                                                className={`${styles.formCheckbox} ${errors.tyc && touched.tyc && styles.formError}`}
                    ...
                    <div className={styles.formFooter}>
                        <div className={styles.formButtonContainer}>
                            <button className={`${styles.buttonPrimary} ${!successForm && styles.buttonDisabled}`} onClick={handleTransactionToken}>Pagar</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default CustomPayFormApp;
